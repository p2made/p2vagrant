...
class CLI
{
    ...
    {
        echo -e "Usage: highlight-query --query SQL [--format html|cli|text] [--ansi]\n";
        echo -e "       cat file.sql | highlight-query\n";
    }
    ...
    public function parseHighlight()
    {
        ...
        if (! in_array($params['f'], ['html', 'cli', 'text'])) {
            echo -e "ERROR: Invalid value for format!\n";
    ...
    {
        echo -e "Usage: lint-query --query SQL [--ansi]\n";
        echo -e "       cat file.sql | lint-query\n";
    }
    ...
    {
        echo -e "Usage: tokenize-query --query SQL [--ansi]\n";
        echo -e "       cat file.sql | tokenize-query\n";
    }
