...
if [ ! -f /var/www/provision/apache/ssl/_hostname_.key ]; then
  openssl req -x509 \
    -newkey rsa:2048 \
    -sha256 \
    -days 730 \
...
openssl genrsa \
  -out /var/www/provision/apache/ssl/_hostname_.key \
  2048
openssl req -new -x509 \
  -key /var/www/provision/apache/ssl/_hostname_.key \
  -out /var/www/provision/apache/ssl/_hostname_.cert \
  -days 3650 \
  -subj /CN=_hostname_
